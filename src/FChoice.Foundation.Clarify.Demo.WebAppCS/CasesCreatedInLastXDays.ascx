<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CasesCreatedInLastXDays.ascx.cs" Inherits="FChoice.Foundation.Clarify.Demo.WebAppCS.CasesCreatedInLastXDays" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
